...
df_creator.add_stimulus("stimulus_2", starts=starts, ends=ends, stimulus_repeat_logic=1, stimulus_repeat_sublogic=1,
                        random_ids=random_ids)
...
extr = Extractors.Extractor_KS(r"D:\Florencia_data\sorting\spike_times.npy", df_creator.stimulus_df)
...
recording = Overview.Recording(extr.file_parquet,
