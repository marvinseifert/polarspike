...
if __name__ == "__main__":
    ...
    recordings.dataframes["fff_stim"] = recordings.dataframes["fff_stim"].query(
        "recording != 'zebrafish_19_04_2024_p1'"
    )
    ...
    # %% parallel results
    nr_cpus = np.min([mp.cpu_count(), len(df_list)])
    ...
    # %%
    all_results_df.write_parquet(
        r"A:\Marvin\fff_clustering_zf\all_results_fff_all.parquet"
    )
    binned_spikes.write_parquet(
        r"A:\Marvin\fff_clustering_zf\binned_spikes_fff_all.parquet"
    )
#
#
# # %%
